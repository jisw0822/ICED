...
#define _DIST_MIN 180.0  //180으로 // minimum distance to be measured (unit: mm)
#define _DIST_MAX 360.0   //360으로// maximum distance to be measured (unit: mm)
...
void loop() {
  ...
  if ( dist_ema <= _TARGET_LOW ){
    ...
    myservo.writeMicroseconds((_DUTY_MAX - _DUTY_MIN) / 180.0 * (dist_ema - 180) + _DIST_MIN);
