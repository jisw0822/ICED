...
void loop() {
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(4, 0.5)); // Replace n with your desired value
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1125 + -9.91*x + 0.0236*x*x + 1.16E-04*x*x*x + -7.56E-07*x*x*x*x + 1.44E-09*x*x*x*x*x + -9.21E-13*x*x*x*x*x*x; 
}
